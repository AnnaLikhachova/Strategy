...
public class Play extends Application {
	...
	URL url1 = this.getClass().getClassLoader().getResource("/Resources/screen.jpeg");
	Image screen = new Image(getClass().getResourceAsStream("/Resources/screen.jpeg"));
	Image b = new Image(getClass().getResourceAsStream("/Resources/Name.png"));
	Image back = new Image(getClass().getResourceAsStream("/Resources/Ba1.png"));
	Image arm = new Image(getClass().getResourceAsStream("/Resources/ar.png"));
	Image scie = new Image(getClass().getResourceAsStream("/Resources/scien.png"));
	Image sol = new Image(getClass().getResourceAsStream("/Resources/soldier.png"));
	Image arch = new Image(getClass().getResourceAsStream("/Resources/archer.png"));
	Image mg = new Image(getClass().getResourceAsStream("/Resources/mag.png"));
	Image solIcon = new Image(getClass().getResourceAsStream("/Resources/swo.png"));
	Image archIcon = new Image(getClass().getResourceAsStream("/Resources/bowi.png"));
	Image buildi = new Image(getClass().getResourceAsStream("/Resources/h3.png"));
	Image lib = new Image(getClass().getResourceAsStream("/Resources/library.png"));
	Image far = new Image(getClass().getResourceAsStream("/Resources/farm.png"));
	Image fore = new Image(getClass().getResourceAsStream("/Resources/forest.png"));
	Image barr = new Image(getClass().getResourceAsStream("/Resources/barracks.png"));
	Image min = new Image(getClass().getResourceAsStream("/Resources/mine.png"));
	Image tem = new Image(getClass().getResourceAsStream("/Resources/temple.png"));
	Image thea = new Image(getClass().getResourceAsStream("/Resources/theatre.png"));
	Image lab = new Image(getClass().getResourceAsStream("/Resources/lab.png"));
	Image ba = new Image(getClass().getResourceAsStream("/Resources/market.png"));
	Image agricul = new Image(getClass().getResourceAsStream("/Resources/Agriculture.png"));
	Image minin = new Image(getClass().getResourceAsStream("/Resources/Mining.png"));
	Image writ = new Image(getClass().getResourceAsStream("/Resources/Writing.png"));
	Image archerytech = new Image(getClass().getResourceAsStream("/Resources/Archery.png"));
	Image curren = new Image(getClass().getResourceAsStream("/Resources/Currency.png"));
	Image dram = new Image(getClass().getResourceAsStream("/Resources/Drama.png"));
	Image philos = new Image(getClass().getResourceAsStream("/Resources/Philosophy.png"));
	Image guil = new Image(getClass().getResourceAsStream("/Resources/Guilds.png"));
	Image eng = new Image(getClass().getResourceAsStream("/Resources/Engineering.png"));
	Image alex = new Image(getClass().getResourceAsStream("/Resources/Alex.jpg"));
	Image alex2 = new Image(getClass().getResourceAsStream("/Resources/Alex 2.jpg"));
	Image ahil = new Image(getClass().getResourceAsStream("/Resources/Ahil.jpg"));
	Image ahil2 = new Image(getClass().getResourceAsStream("/Resources/Ahil 2.jpg"));
	Image cesar = new Image(getClass().getResourceAsStream("/Resources/Cesar.jpg"));
	Image cesar2 = new Image(getClass().getResourceAsStream("/Resources/Cesar 2.jpg"));
	Image kleopatra = new Image(getClass().getResourceAsStream("/Resources/kleopatra.jpg"));
	Image kleopatra2 = new Image(getClass().getResourceAsStream("/Resources/kleopatra 2.jpg"));
	Image alex3 = new Image(getClass().getResourceAsStream("/Resources/Alex 3.jpg"));
	Image ahil3 = new Image(getClass().getResourceAsStream("/Resources/Ahil 3.jpg"));
	Image cesar3 = new Image(getClass().getResourceAsStream("/Resources/Cesar 3.jpg"));
	Image kleopatra3 = new Image(getClass().getResourceAsStream("/Resources/kleopatra 3.jpg"));

	Button alexb = new Button(null, new ImageView(alex3));
	Button ahilb = new Button(null, new ImageView(ahil3));
	Button cesarb = new Button(null, new ImageView(cesar3));
	Button kleopatrab = new Button(null, new ImageView(kleopatra3));
	static Button start1 = new Button("START GAME");
	Button howtoplay = new Button("HOW TO PLAY");
	Button options = new Button("SCORE TABLE");
	Button quit = new Button("QUIT");
	Button backtoMainMenu = new Button("BACK");
	Button backtoMenu = new Button("BACK");
	Button backtoPlayMenu = new Button("BACK");
	Button war = new Button("LET'S BEGIN WAR");
	Button backtoPlay = new Button(null, new ImageView(back));
	Button armyb = new Button(null, new ImageView(arm));
	Button scienceb = new Button(null, new ImageView(scie));
	Button buildb = new Button(null, new ImageView(buildi));
	Button ahilp = new Button("PLAY");
	Button cesarp = new Button("PLAY");
	Button alexp = new Button("PLAY");
	Button kleopatrap = new Button("PLAY");
	Button agriculture = new Button(null, new ImageView(agricul));
	Button mining = new Button(null, new ImageView(minin));
	Button writing = new Button(null, new ImageView(writ));
	Button archery = new Button(null, new ImageView(archerytech));
	Button currency = new Button(null, new ImageView(curren));
	Button drama = new Button(null, new ImageView(dram));
	Button philosophy = new Button(null, new ImageView(philos));
	Button guild = new Button(null, new ImageView(guil));
	Button engineering = new Button(null, new ImageView(eng));
	Button library = new Button(null, new ImageView(lib));
	Button forest = new Button(null, new ImageView(fore));
	Button farm = new Button(null, new ImageView(far));
	Button mine = new Button(null, new ImageView(min));
	Button temple = new Button(null, new ImageView(tem));
	Button theatre = new Button(null, new ImageView(thea));
	Button laboratory = new Button(null, new ImageView(lab));
	Button baracks = new Button(null, new ImageView(barr));
	Button market = new Button(null, new ImageView(ba));
	Button sword = new Button(null, new ImageView(sol));
	Button bow = new Button(null, new ImageView(arch));
	Button magik = new Button(null, new ImageView(mg));
	Label sk = new Label();
	Label ak = new Label();
	Label mk = new Label();
	Label l = new Label();
	static Label golde = new Label();
	static Label culturee = new Label();
	static Label religione = new Label();
	static Label sciencee = new Label();
	String str = "";

	boolean libB = false;
	boolean farmB = false;
	boolean forestB = false;
	boolean mineB = false;
	boolean theaB = false;
	boolean tempB = false;
	boolean markB = false;
	...
	boolean cesarf = false;
	boolean kleopatraf = false;
	boolean ahilf = false;
	boolean alexf = false;
	static boolean clickS = false;
	static boolean goldS = false;
